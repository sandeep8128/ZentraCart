...
function Home() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAF7F6] dark:bg-[#121212]">
        {/* ── HERO ─────────────────────────────────────────── */}
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-6 py-20 lg:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                />
                <span
                  style={{ color: "#93C5FD", fontSize: 13, fontWeight: 500 }}
                >
              ...
              >
                ZentraCart brings you handpicked deals across electronics,
                fashion, beauty &amp; more — at prices that make sense.
              </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16">
          ...
          {filtered.length === 0 ? (
            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-12 text-center text-sm text-gray-400">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-2 gap-8 text-center md:grid-cols-4">
            {[
              ...
              <div key={title}>
                ...
                <p
                  style={{ color: "#64748b", fontSize: 12, margin: "4px 0 0" }}
                >
                  {sub}
                </p>
              </div>
        ...
        >
          {/* Outer glow */}
          <div className="absolute inset-0 -m-3 animate-pulse rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 opacity-40 blur-lg" />

          {/* Spinning ring 1 */}
          <div
            className="absolute inset-0 -m-2.5 animate-spin rounded-full border border-transparent"
            style={{
              borderTopColor: "rgba(88,130,244,0.7)",
          ...
          {/* Spinning ring 2 */}
          <div
            className="absolute inset-0 -m-5 rounded-full border border-transparent"
            style={{
              borderBottomColor: "rgba(236,72,153,0.5)",
              borderLeftColor: "rgba(88,130,244,0.35)",
          ...
          {/* Main button */}
          <div
            className="relative flex h-18 w-18 items-center justify-center rounded-full shadow-2xl transition-transform duration-200 hover:scale-110 active:scale-95"
            style={{
              width: "72px",
              height: "72px",
              background:
                "linear-gradient(135deg, #5882f4 0%, #a855f7 60%, #ec4899 100%)",
              boxShadow:
                "0 8px 32px rgba(88,130,244,0.5), 0 2px 8px rgba(0,0,0,0.2)",
            }}
          >
            {/* Sparkle icon */}
            <svg
          ...
          {/* Label */}
          <p className="mt-2 text-center text-[11px] font-medium tracking-wide text-gray-400">
            AI Assistant
          </p>
        </div>
        ...
        >
          <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-3">
            <div>
              ...
              >
                Discover premium products from trusted sellers with a seamless
                shopping experience.
              </p>
            </div>
